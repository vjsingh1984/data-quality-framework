...
def df_long_incoming(spark):
    ...
    incoming_data = [("John", 25, "2021-01-01"), ("Doe", 30, "2021-01-02"), ("Jane", 40, "2021-01-03")]
...
def df_float_incoming(spark):
    # Example DataFrame with incoming data
    incoming_data = [("John", 25.1, "2021-01-01"), ("Doe", 30.9, "2021-01-02"), ("Jane", 40.03, "2021-01-03")]
    incoming_data_schema = StructType([
        StructField("name",         StringType(),   False),
...
def test_schemavalidation_single_check_mode_success(spark, df_incoming, single_schemavalidation_config):
    assert True == process_schemavalidation_success(spark,df_incoming, single_schemavalidation_config), "Atleast one metric failed."

def test_schemavalidation_single_check_mode_failure(spark, df_incoming, single_schemavalidation_config):
    assert False == process_schemavalidation_failure(spark,df_incoming, single_schemavalidation_config), "Atleast one metric should have failed."

def test_schemavalidation_integer_type_success(spark, df_integer_incoming, single_schemavalidation_config):
    assert True == process_schemavalidation_success(spark,df_integer_incoming, single_schemavalidation_config), "Atleast one metric failed."

def test_schemavalidation_integer_type_failure(spark, df_integer_incoming, single_schemavalidation_config):
    assert False == process_schemavalidation_failure(spark,df_integer_incoming, single_schemavalidation_config), "Atleast one metric should have failed."
...
def test_schemavalidation_float_type_failure(spark, df_float_incoming, single_schemavalidation_config):
    assert False == process_schemavalidation_failure(spark,df_float_incoming, single_schemavalidation_config), "Atleast one metric should have failed."

def test_schemavalidation_double_type_success(spark, df_double_incoming, single_schemavalidation_config):
    assert True == process_schemavalidation_success(spark,df_double_incoming, single_schemavalidation_config), "Atleast one metric failed."

def test_schemavalidation_double_type_failure(spark, df_double_incoming, single_schemavalidation_config):
    assert False == process_schemavalidation_failure(spark,df_double_incoming, single_schemavalidation_config), "Atleast one metric should have failed."

def test_schemavalidation_decimal_type_success(spark, df_decimal_incoming, single_schemavalidation_config):
    assert True == process_schemavalidation_success(spark,df_decimal_incoming, single_schemavalidation_config), "Atleast one metric failed."

def test_schemavalidation_decimal_type_failure(spark, df_decimal_incoming, single_schemavalidation_config):
    assert False == process_schemavalidation_failure(spark,df_decimal_incoming, single_schemavalidation_config), "Atleast one metric should have failed."

def test_schemavalidation_date_type_success(spark, df_date_incoming, single_schemavalidation_config):
    assert True == process_schemavalidation_success(spark,df_date_incoming, single_schemavalidation_config), "Atleast one metric failed."

def test_schemavalidation_date_type_failure(spark, df_date_incoming, single_schemavalidation_config):
    assert False == process_schemavalidation_failure(spark,df_date_incoming, single_schemavalidation_config), "Atleast one metric should have failed."

def test_schemavalidation_timestamp_type_success(spark, df_timestamp_incoming, single_schemavalidation_config):
    assert True == process_schemavalidation_success(spark,df_timestamp_incoming, single_schemavalidation_config), "Atleast one metric failed."

def test_schemavalidation_timestamp_type_failure(spark, df_timestamp_incoming, single_schemavalidation_config):
    assert False == process_schemavalidation_failure(spark,df_timestamp_incoming, single_schemavalidation_config), "Atleast one metric should have failed."

def test_nullable_false_schemavalidation_single_check_success(spark):
    # Example DataFrame with incoming data
    incomingnullable_data = [("John", 25.1, "2021-01-01"), ("Doe", 30.1, "2021-01-02"), ("Jane", 40.1, "2021-01-03")]
