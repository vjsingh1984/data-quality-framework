...
def test_rate_of_change(spark, custom_config_rate_of_change, multi_column_dataframe_rate_of_change):
...
def test_wide_col_negative_values(spark, custom_config_wide_col_negative_values, numeric_dataframe):
